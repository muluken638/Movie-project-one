          ...
          <div className="p-6 pt-0">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-4 flex items-center justify-end gap-x-2">
                <Loginbtn />
                <button
                  className="font-semibold hover:bg-black hover:text-white transition duration-300 inline-flex items-center justify-center rounded-md text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-black h-10 px-4 py-2"
                  type="submit"
                >
                  Register
                </button>
